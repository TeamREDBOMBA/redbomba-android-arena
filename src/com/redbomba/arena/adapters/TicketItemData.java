...
public class TicketItemData {
    ...
    public TicketItemData(String text1, String text2, String text3, String text4, String text5, String text6, String text7, String text8) {
        m_text1 = text1;
        m_text2 = text2;
        m_text3 = text3;
        m_text4 = text4;
    ...
    public String getText8() { return m_text8; }
